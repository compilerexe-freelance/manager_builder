      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/save_info') }}">
              {{ csrf_field() }}
              <input type="hidden" name="username" value="{{ Auth::user()->username }}">
              <div class="form-group">
                <label for="code" class="col-md-4 control-label">รหัสสมาชิก</label>
                <div class="col-md-6">
                  <input id="code" type="text" class="form-control" name="code" value="{{ Auth::user()->code }}" readonly="readonly">
                </div>
              </div>
              ...
              <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <textarea id="address" class="form-control" name="address" rows="5" style="resize:none">{{ Auth::user()->address }}</textarea>
              ...
              <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <input id="password" type="password" class="form-control" name="password" value="{{ Auth::user()->password }}" placeholder="ขั้นต่ำ 4 ตัวอักษร">
              ...
              <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" value="{{ Auth::user()->password }}" placeholder="ขั้นต่ำ 4 ตัวอักษร">
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-4 text-right">
                  <a href="{{ url('home') }}" style="margin-right:5px">
