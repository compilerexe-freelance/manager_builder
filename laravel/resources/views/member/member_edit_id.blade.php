    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">แก้ไขสมาชิกหน่วยงาน</div>
          <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/member_edit_id') }}">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input id="code" type="text" class="form-control" name="code" value="{{ $member->code }}" readonly="readonly">
                </div>
              </div>
              ...
              <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <input id="username" type="text" class="form-control" name="username" value="{{ $member->username }}" readonly>
              ...
              <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <input id="password" type="password" class="form-control" name="password" value="{{ $member->password }}" placeholder="ขั้นต่ำ 4 ตัวอักษร">
              ...
              <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" value="{{ $member->password }}" placeholder="ขั้นต่ำ 4 ตัวอักษร">
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-4 text-right">
                  <a href="{{ url('/member_edit') }}" style="margin-right:5px">
